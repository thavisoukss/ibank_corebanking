 ...
 *                   &lt;element name="Detb-Jrnl-Txn-Master--Auth-IO" type="{http://fcubs.ofss.com/service/FCUBSACService}MultiJrnlAuth-Modify-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "MODIFYMJRNLAUTH_IOPK_RES")
public class MODIFYMJRNLAUTHIOPKRES {
