 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Query-Details-IO" type="{http://fcubs.ofss.com/service/FCUBSACService}CustAcTrn-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Query-Details-Full" type="{http://fcubs.ofss.com/service/FCUBSACService}CustAcTrn-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYCUSTACTRN_IOFS_RES")
public class QUERYCUSTACTRNIOFSRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Query-Details-IO")
        protected CustAcTrnQueryIOType queryDetailsIO;
        @XmlElement(name = "Query-Details-Full")
        protected CustAcTrnFullType queryDetailsFull;
        ...
        /**
         * Gets the value of the queryDetailsIO property.
         * 
         * @return
         *     possible object is
         *     {@link CustAcTrnQueryIOType }
         *     
         */
        public CustAcTrnQueryIOType getQueryDetailsIO() {
            return queryDetailsIO;
        }

        /**
         * Sets the value of the queryDetailsIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link CustAcTrnQueryIOType }
         *     
         */
        public void setQueryDetailsIO(CustAcTrnQueryIOType value) {
            this.queryDetailsIO = value;
        }

        /**
         * Gets the value of the queryDetailsFull property.
         * 
         * @return
         *     possible object is
         *     {@link CustAcTrnFullType }
         *     
         */
        public CustAcTrnFullType getQueryDetailsFull() {
            return queryDetailsFull;
        }

        /**
         * Sets the value of the queryDetailsFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link CustAcTrnFullType }
         *     
         */
        public void setQueryDetailsFull(CustAcTrnFullType value) {
            this.queryDetailsFull = value;
        }
