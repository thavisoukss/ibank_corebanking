 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Acvw-Acdaudtr-IO" type="{http://fcubs.ofss.com/service/FCUBSACService}ACDAUDTR-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Acvw-Acdaudtr-Full" type="{http://fcubs.ofss.com/service/FCUBSACService}ACDAUDTR-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYAUDITTRAIL_IOFS_RES")
public class QUERYAUDITTRAILIOFSRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Acvw-Acdaudtr-IO")
        protected ACDAUDTRQueryIOType acvwAcdaudtrIO;
        @XmlElement(name = "Acvw-Acdaudtr-Full")
        protected ACDAUDTRFullType acvwAcdaudtrFull;
        ...
        /**
         * Gets the value of the acvwAcdaudtrIO property.
         * 
         * @return
         *     possible object is
         *     {@link ACDAUDTRQueryIOType }
         *     
         */
        public ACDAUDTRQueryIOType getAcvwAcdaudtrIO() {
            return acvwAcdaudtrIO;
        }

        /**
         * Sets the value of the acvwAcdaudtrIO property.
         * 
         * @param value
         *     allowed object is
         *     {@link ACDAUDTRQueryIOType }
         *     
         */
        public void setAcvwAcdaudtrIO(ACDAUDTRQueryIOType value) {
            this.acvwAcdaudtrIO = value;
        }

        /**
         * Gets the value of the acvwAcdaudtrFull property.
         * 
         * @return
         *     possible object is
         *     {@link ACDAUDTRFullType }
         *     
         */
        public ACDAUDTRFullType getAcvwAcdaudtrFull() {
            return acvwAcdaudtrFull;
        }

        /**
         * Sets the value of the acvwAcdaudtrFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link ACDAUDTRFullType }
         *     
         */
        public void setAcvwAcdaudtrFull(ACDAUDTRFullType value) {
            this.acvwAcdaudtrFull = value;
        }
