 ...
 *                   &lt;element name="Product-Details-IO" type="{http://fcubs.ofss.com/service/FCUBSFTService}Product-Delete-IO-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "DELETEPRODUCT_IOPK_RES")
public class DELETEPRODUCTIOPKRES {
