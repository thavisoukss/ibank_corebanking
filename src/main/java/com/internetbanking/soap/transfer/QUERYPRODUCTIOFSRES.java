 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="Product-Details-IO" type="{http://fcubs.ofss.com/service/FCUBSFTService}Product-Query-IO-Type" minOccurs="0"/&gt;
 *                   &lt;element name="Product-Details-Full" type="{http://fcubs.ofss.com/service/FCUBSFTService}Product-Full-Type" minOccurs="0"/&gt;
...
@XmlRootElement(name = "QUERYPRODUCT_IOFS_RES")
public class QUERYPRODUCTIOFSRES {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Product-Details-IO")
        protected ProductQueryIOType productDetailsIO;
        @XmlElement(name = "Product-Details-Full")
        protected ProductFullType productDetailsFull;
         ...
         * @return
         *     possible object is
         *     {@link ProductQueryIOType }
         *     
         */
        public ProductQueryIOType getProductDetailsIO() {
         ...
         *     
         */
        public void setProductDetailsIO(ProductQueryIOType value) {
            this.productDetailsIO = value;
        }

        /**
         * Gets the value of the productDetailsFull property.
         * 
         * @return
         *     possible object is
         *     {@link ProductFullType }
         *     
         */
        public ProductFullType getProductDetailsFull() {
            return productDetailsFull;
        }

        /**
         * Sets the value of the productDetailsFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link ProductFullType }
         *     
         */
        public void setProductDetailsFull(ProductFullType value) {
            this.productDetailsFull = value;
        }
